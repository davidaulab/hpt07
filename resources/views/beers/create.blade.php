...
<form method="POST" action="{{ route ('beers.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" id="vol" name="vol" step="0.01"   value="{{ old ('vol') }}" required />
